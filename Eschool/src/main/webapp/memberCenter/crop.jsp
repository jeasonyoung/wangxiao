...
<%@page import="com.changh.eschool.until.*" %>
<%@page import="java.io.*" %>
...
String cutImg = ((Student)session.getAttribute("student")).getStuUsername()+"_."+suffix;
...
fileWebroot = fileWebroot+"upload"+separator+"userface";
