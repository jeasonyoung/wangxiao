...
<tbody>
<tr>
   <td height="24" bgcolor="#f9f9f9" align="center" width="410" class="xxzx_ber_a"><strong>课程名称</strong></td>
...
<tr>
   ...
   <s:iterator value="#cp.grade" var="g" status="status">
	...
	<td  class="xxzx_ber_e font_14"> &nbsp;&nbsp;
       <a href="javascript:;" onclick="showPapers(${g.gradeId})" id="${g.gradeId}" title="${g.examCategory.examName}-${g.gradeCategory.gtypeName}">${g.examCategory.examName}-${g.gradeCategory.gtypeName}</a>
    ...
    <td align="center" class="xxzx_ber_e font_12">
 		<a href="javascript:;" onclick="showPapers(${g.gradeId})">做作业</a>
  </td>
</tr>
   </s:iterator>
   </tbody>
...
<tr>                                    
	<td width="410" class="xxzx_ber_e font_14"> &nbsp;<img src="../images/pic_bh.gif">&nbsp;
       <a href="javascript:;" onclick="showPapers(${g.gradeId})" title="${g.examCategory.examName}-${g.gradeCategory.gtypeName}">${g.examCategory.examName}-${g.gradeCategory.gtypeName}</a>
       <input type="hidden" id="name_${g.gradeId }" value="${g.examCategory.examName}-${g.gradeCategory.gtypeName}">
    </td>
    <td align="center" width="54" class="xxzx_ber_e font_14"></td>                               
