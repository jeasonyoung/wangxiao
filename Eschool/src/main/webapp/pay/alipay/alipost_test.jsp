...
<form name=alipayment action=notify_url.jsp
	method=post target="_blank">
<div id="body" style="clear: left">
<dl class="content">
	<input type="hidden" name="trade_status" value="TRADE_FINISHED"/>
	<dt>标题：</dt>
	<dd><span class="red-star">*</span> <input size=30 name=subject value="hahaha共选择了1门课程" />
	<span>如：7月5日定货款。</span></dd>
	<dt>淘宝交易号：</dt>
	<dd><span class="red-star">*</span> <input size=30 name=trade_no  value="201303141526"/>
	<span>如：7月5日定货款。</span></dd>
	<dt>订单号：</dt>
	<dd><span class="red-star">*</span> <input size=30 name=out_trade_no value="201302231006" />
	<span>如：7月5日定货款。</span></dd>
	<dt>付款金额：</dt>
	<dd><span class="red-star">*</span> <input maxLength=10 size=30
		name=total_fee onfocus="if(Number(this.value)==0){this.value='';}"
		value="0.01" /> <span>如：112.21</span></dd>
	<dt>备注：</dt>
	<dd><span class="null-star">*</span> <textarea
		style="margin-left: 3px;" name=body rows=2 cols=40 wrap="physical">作图全科套餐|赠送：作图教材</textarea><br />
