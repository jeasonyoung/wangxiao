...
<%@ page import="com.changh.eschool.pay.tenpay.util.TenpayUtil" %>
<%@ page import="com.changh.eschool.pay.tenpay.RequestHandler"%>
...
//获取提交的商品价格
String order_price=(String)request.getAttribute("tradeMoney");
/* 商品价格（包含运费），以分为单位 */
double total_fee = (Double.valueOf(order_price) * 100);
int fee = (int)total_fee;
  
//获取提交的商品名称
String product_name=(String)request.getAttribute("subject");  

//获取提交的备注信息
String remarkexplain=request.getParameter("remarkexplain");  
String attach = (String)request.getAttribute("body");

String desc = (String)request.getAttribute("body");

//获取提交的订单号
String out_trade_no=(String)request.getAttribute("orderNo");  
...
<body onLoad="javascript:window.location='<%=requestUrl%>'">
</body>
</html>
