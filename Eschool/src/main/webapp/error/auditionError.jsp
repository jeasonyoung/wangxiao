<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
  "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="utf-8" %>
...
<body class="login">
  <div class="error_page">
    ...
    <h1>对不起...</h1>
    <p>你选择的课程或者套餐暂时无法试听....</p>
    <p><a href="javascript:window.opener=null;window.open('','_self');window.close();">关闭本页</a></p>
  </div>
</body>
</html>
