    ...
    <script type="text/javascript">
        $(function ()
        {
            ...
            function dologin()
            {
                ...
                var pwd = /^[0-9a-zA-Z_]+$/;
                if(!pwd.test(password)||password.length<6||password.length>17){
                	alert('密码不合法');
                	$("#txtPassword").focus();
                    return;
                }
                    ...
                    <table cellpadding="0" cellspacing="0">
                        <tbody>
                         <tr>
                            ...
                            <tr>
                            <td align="right">账号：</td><td align="left"><input type="text" name="loginusername" id="txtUsername" class="login-text" value="${cookie.sccms_user.value }"/></td>
                            </tr>
                            <tr>
