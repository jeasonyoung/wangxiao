...
<script type="text/javascript">
    ...
    function f_preview(){
    	 window.loginWin=$.ligerDialog.open({ 
	          	  	url: "http://localhost:8080/common/foot"+f_page()+".html",
	          	    title:'预览',
	          	    isHidden: false,
	          	    ...
	          	    buttons: [ { text: '下一个', 
	          	    	onclick: function (item, dialog) { 	
									window.loginWin.set({url:"http://localhost:8080/common/foot"+f_page()+".html"});
	          	    			}
	          	    		 }
	          	     	] 
	          	    });	       
    ...
    function f_release(){
    	$.post("${pageContext.request.contextPath}/release/releaseFoot",
          					function(ok){
          						if(ok==true){
