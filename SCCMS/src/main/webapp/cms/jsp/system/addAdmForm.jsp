        ...
        $(function ()
        {
            $("#Button1").click(
            	function(){
            		...
            		{
            			$.post(
            				"${pageContext.request.contextPath}/user/addAdmin",
            				{"admin.admUsername":$("#username").val(),"admin.admPassword":$("#pwd").val(),"admin.admName":$("#name").val(),"admin.admStatus":$("input[name='admin.admStatus']:checked").val(),roleId:$("#roleId").val()},
            				function(data)
            				{
            					if(data)
            					{
            						$.ligerDialog.success( '操作成功!', function ()
                					{
                						...
                						parent.parent.closeTab("addAdmin");
                						parent.$("iframe[name='searchAdmin']")[0].contentWindow.f_reload();
                						parent.closeTab("addAdmin1");
                					}); 
            					}else
            					{
    ...
    <form name="form1" method="post"  id="form1" action="${pageContext.request.contextPath}/user/addAdmin">
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td" style="width:160px" ><input class="l-text" name="admin.admUsername" type="text" id="username" value="" /></td>
                <td align="left"><span style="color:red" id="nameInfo"></span></td>
            </tr>
             <tr>
                <td align="right" class="l-table-edit-td">姓名:</td>
             	<td align="left" class="l-table-edit-td" style="width:160px" ><input class="l-text" name="admin.admName" type="text" id="name" value="" /></td>
           ...
           <tr>
                ...
                <td align="left" class="l-table-edit-td" style="width:160px" ><input class="l-text" name="admin.admPassword" type="password" id="pwd" value="" /></td>
                <td align="left"><span style="color:red" id="pwdInfo"></span></td>
            </tr>
             <tr>
                <td align="right" class="l-table-edit-td">重复密码:</td>
                <td align="left" class="l-table-edit-td" style="width:160px" ><input class="l-text" type="password" id="pwd2" ltype="text" /></td>
