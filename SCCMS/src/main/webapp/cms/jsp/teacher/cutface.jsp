            	...
            	function(){
            		if(checkAll())
            		{
            			cropzoom.send('${pageContext.request.contextPath}/cms/jsp/teacher/crop.jsp', 'POST', {}, function(imgRet) {
            				...
            				{"teacher.tchUsername":$("#username").val(),"teacher.tchPassword":$("#pwd").val(),"teacher.tchName":$("#name").val(),"teacher.tchStatus":$("input[name='teacher.tchStatus']:checked").val(),"teacher.tchSex":$("input[name='teacher.tchSex']:checked").val(),"teacher.tchPhone":$("#phone").val(),"teacher.tchLessons":$("#exam").val(),"teacher.tchDescription":$("#description").val(),"teacher.tchImgUrl":imgurl},
            				function(data){
            					if(data)
            					{
    ...
    <form name="form1" method="post"  id="form1" action="${pageContext.request.contextPath}/user/addTeacher">
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        	...
        	<table cellpadding="0" cellspacing="0" class="l-table-edit" >
                ...
                <td align="left" class="l-table-edit-td" style="width:160px" ><input class="l-text" name="teacher.tchUsername" type="text" id="username" value="123456" /></td>
                <td align="left"><span style="color:red" id="nameInfo"></span></td>
            </tr>
           <tr>
                <td align="right" class="l-table-edit-td">密码:</td>
                <td align="left" class="l-table-edit-td" style="width:160px" ><input class="l-text" name="teacher.tchPassword" type="password" id="pwd" value="123456"/></td>
                <td align="left"><span style="color:red" id="pwdInfo"></span></td>
            </tr>
             <tr>
                <td align="right" class="l-table-edit-td">重复密码:</td>
                <td align="left" class="l-table-edit-td" style="width:160px" ><input class="l-text" type="password" id="pwd2" /></td>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td" style="width:160px">
					<input id="upload" style="" type="button" value="重新上传" name="upload" onclick="location='${pageContext.request.contextPath}/cms/jsp/teacher/addTchForm.jsp'">
            ...
            <td rowspan="9"><div id="crop_container2"></div></td>
        	</tr>
