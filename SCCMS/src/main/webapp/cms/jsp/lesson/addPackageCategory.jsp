    ...
    <script type="text/javascript">
        ...
        $(function ()
        {
            ...
            var v = $("form").validate({
                ...
                submitHandler: function ()
                {
                	...
                	$.post("${pageContext.request.contextPath}/package/packageCategoryAdd",{ptypeName:$("#ptypeName").val(),ptypePid:ptypeId,
									ptypeDescription:editor.getContent(),examId:pexamId},
          							function(ok){
          							if(ok==true){
        ...
        $(document).ready(function() {
			$('#fileInput').uploadify( {
				...
				'script' : '${pageContext.request.contextPath}/package/uploadFile;jsessionid=<%=session.getId()%>', 
				'folder' : 'upload',
...
<div>
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        	 <tr>
                ...
                <input name="packageCategory.ptypeName" type="text" id="ptypeName" validate="{required:true,maxlength:15}"/>
                </td>
           	 </tr>
           	 <tr>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"> 
                <textarea cols="100" rows="6" class="l-textarea" id="ptypeDescription" style="width:402px"  name="packageCategory.ptypeDescription"></textarea>
                </td><td align="left"></td>
                <script type="text/javascript" >
