        ...
        $(function ()
        {
            ...
            var v = $("form").validate({
                ...
                submitHandler: function ()
                {
                	...
                	$.post("${pageContext.request.contextPath}/exam/examAdd",
...
<div>
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        	 <tr>
                ...
                <input name="packageCategory.ptypeName" type="text" id="examName"  validate="{required:true,maxlength:15}" />
                </td>
           	 </tr>
           	 <tr>
                <td align="right" class="l-table-edit-td">演示视频:</td>
                <td align="left" class="l-table-edit-td">
                <input name="packageCategory.ptypeName" type="text" id="examUrl" value="http://vps.chuji8.com:8090/2.flv" />
                </td>
           	 </tr>
            <tr>
                <td align="right" class="l-table-edit-td">考试描述:</td>
                <td align="left" class="l-table-edit-td"> 
                <textarea cols="100" rows="6" class="l-textarea" id="ptypeDescription" style="width:402px"  name="packageCategory.ptypeDescription">暂无简介</textarea>
                </td><td align="left"></td>
                <script type="text/javascript">
