    ...
    $.ligerui.controls.ComboBox.ligerExtend($.ligerui.controls.Input, {
        ...
        _setValue: function (value)
        {
            ...
            else
            {
                ...
                $("table.l-table-checkbox a", g.selectBox).removeClass("l-checkbox-checked");  //新增
                                
                for (var i = 0; i < targetdata.length; i++)
                {
                    $("table.l-table-checkbox tr[value=" + targetdata[i] + "] :checkbox", g.selectBox).each(function () { this.checked = true; });
                    $("table.l-table-checkbox tr[value=" + targetdata[i] + "] .l-checkbox", g.selectBox).addClass("l-checkbox-checked");  //新增
                }
            }
        },
