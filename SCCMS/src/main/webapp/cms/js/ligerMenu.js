...
(function ($)
{
    ...
    $.ligerui.controls.Menu.ligerExtend($.ligerui.core.UIComponent, {
        ...
        ///fw 2013.04.26 添加方法设置指定id的名称//
        setItemText:function(itemid,text)
        {
        	var g = this, p = this.options;
            var item = $("> .l-menu-item[menuitemid=" + itemid + "]", g.menu.items);
            $(">.l-menu-item-text:first", item).html(text);
        },
        getItemText:function(itemid)
        {
        	var g = this, p = this.options;
            var item = $("> .l-menu-item[menuitemid=" + itemid + "]", g.menu.items);
            return $(">.l-menu-item-text:first", item).html();
        },
        ////////////////////////////////////////////////////////////////////////////////////
