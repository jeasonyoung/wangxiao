...
public class Log implements java.io.Serializable {
	...
	/** minimal constructor */
	public Log(String admUsername, Date operatetime, Integer operatetype,
			String logconten, String broswer, String ip) {
	...
	/** full constructor */
	public Log(Integer admId, String admUsername, Date operatetime,
